 ...
 *
 * FUNCIONAMIENTO:
 * - Mantiene un archivo JSON con una lista plana de registros.
 ...
 * - Si un valor es null y existe un valor anterior, se usara el ultimo valor conocido.
 *
 * FUNCIONALIDAD:
...
public class HistoricoManager {
    ...
    public static void actualizar(List<Gasolinera> lista) {
        ...
        // Fecha en formato ISO a las 00:00:00Z
    ...
    private static Map<String, List<RegistroHistorico>> cargarHistorico() {
        ...
        try (FileReader reader = new FileReader(file)) {
            ...
            // Si no es un array, se ignora el contenido
            ...
            // Recorrer cada registro del historico
            for (JsonElement e : array) {
                ...
                // Leer valores permitiendo null o claves ausentes
    ...
    private static void guardarHistorico(Map<String, List<RegistroHistorico>> historico) {
        ...
        for (String id : historico.keySet()) {
            ...
            // Convertir cada registro a objeto JSON
        ...
        try {
            ...
            FileWriter fw = new FileWriter(RUTA, java.nio.charset.StandardCharsets.UTF_8);
